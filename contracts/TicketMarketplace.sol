...
contract TicketMarketplace is ITicketMarketplace {
    ...
    function buyTicketsERC20(uint128 eventId, uint128 ticketCount) external {
        ...
        require(erc20.balanceOf(msg.sender) >= totalPriceERC20, "Insufficient ERC20 balance");
        require(erc20.allowance(msg.sender, address(this)) >= totalPriceERC20, "Insufficient allowance");
